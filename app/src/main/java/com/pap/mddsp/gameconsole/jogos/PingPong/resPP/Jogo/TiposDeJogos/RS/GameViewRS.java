...
public class GameViewRS extends SurfaceView
{
    public GameThreadRS thread;
    SurfaceHolder holder;
    public int screenWidth;
    public int screenHeigth;

    protected Ping_Pong_RS Pai;

    public GameViewRS(Context contextt, Ping_Pong_RS pai) {
        super(contextt);

        Pai = pai;

        thread = new GameThreadRS(this, contextt);
        holder = getHolder();
    ...
    public GameThreadRS getGameThread() {
        return thread;
    }
