...
public class GameThreadIB extends Thread {

    /** Handle to the surface manager object we interact with */
    private Paint paint;
    private Context context;
    protected GameStateIB state;
    private GameViewIB Pai;
    private boolean out = false;
    public boolean running = false;

    public GameThreadIB(GameViewIB Paii, Context contextt)
    {
        paint = new Paint();
        Pai = Paii;
        state = new GameStateIB(contextt);
        context = contextt;
    }
