...
public class GameStateSS2 {
    ...
    public GameStateSS2(Context contextt)
    {
        context = contextt;
        bottomBatX = 0;
        bottomBatY = 0;
    ...
    public void veriCBB()
    {
        int randomB2 = new Random().nextInt(100);

        if(randomB2 > 98){
            ball.speedY = ball.speedYF;
        }

        int randomB1 = new Random().nextInt(100);
