...
public class GameViewIB extends SurfaceView
{
    public GameThreadIB thread;
    SurfaceHolder holder;
    public int screenWidth;
    public int screenHeigth;

    protected Ping_Pong_IB Pai;

    public GameViewIB(Context contextt, Ping_Pong_IB pai) {
        super(contextt);

        Pai = pai;

        thread = new GameThreadIB(this, contextt);
        holder = getHolder();
    ...
    public GameThreadIB getGameThread() {
        return thread;
    }
