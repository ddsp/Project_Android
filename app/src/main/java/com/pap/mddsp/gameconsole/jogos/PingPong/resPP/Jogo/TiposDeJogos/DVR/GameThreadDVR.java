...
public class GameThreadDVR extends Thread {

    /** Handle to the surface manager object we interact with */
    private Paint paint;
    private Context context;
    protected GameStateDVR state;
    private GameViewDVR Pai;
    public boolean running = false;
    private boolean out = false;

    public GameThreadDVR(GameViewDVR Paii, Context contextt)
    {
        paint = new Paint();
        Pai = Paii;
        state = new GameStateDVR(contextt);
        context = contextt;
    }
