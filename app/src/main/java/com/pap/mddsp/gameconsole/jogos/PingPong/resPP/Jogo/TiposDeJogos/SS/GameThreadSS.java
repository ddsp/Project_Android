...
public class GameThreadSS extends Thread {

    /** Handle to the surface manager object we interact with */
    private Paint paint;
    private Context context;
    protected GameStateSS state;
    private GameViewSS Pai;
    private boolean out = false;
    public boolean running = false;

    public GameThreadSS(GameViewSS Paii, Context contextt)
    {
        paint = new Paint();
        Pai = Paii;
        state = new GameStateSS(contextt);
        context = contextt;
    }
