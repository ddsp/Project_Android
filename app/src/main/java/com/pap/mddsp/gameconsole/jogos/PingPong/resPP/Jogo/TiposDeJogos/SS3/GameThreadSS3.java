...
public class GameThreadSS3 extends Thread {

    /** Handle to the surface manager object we interact with */
    private Paint paint;
    private Context context;
    protected GameStateSS3 state;
    private GameViewSS3 Pai;
    private boolean out = false;
    public boolean running = false;

    public GameThreadSS3(GameViewSS3 Paii, Context contextt)
    {
        paint = new Paint();
        Pai = Paii;
        state = new GameStateSS3(contextt);
        context = contextt;
    }
