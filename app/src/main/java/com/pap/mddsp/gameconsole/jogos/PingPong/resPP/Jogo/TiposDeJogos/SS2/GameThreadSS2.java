...
public class GameThreadSS2 extends Thread {

    /** Handle to the surface manager object we interact with */
    private Paint paint;
    private Context context;
    protected GameStateSS2 state;
    private GameViewSS2 Pai;
    private boolean out = false;
    public boolean running = false;

    public GameThreadSS2(GameViewSS2 Paii, Context contextt)
    {
        paint = new Paint();
        Pai = Paii;
        state = new GameStateSS2(contextt);
        context = contextt;
    }
