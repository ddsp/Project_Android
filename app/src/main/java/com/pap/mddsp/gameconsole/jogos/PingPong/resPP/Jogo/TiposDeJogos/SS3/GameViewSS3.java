...
public class GameViewSS3 extends SurfaceView
{
    public GameThreadSS3 thread;
    SurfaceHolder holder;
    public int screenWidth;
    public int screenHeigth;

    protected Ping_Pong_SS3 Pai;

    public GameViewSS3(Context contextt, Ping_Pong_SS3 pai) {
        super(contextt);

        Pai = pai;

        thread = new GameThreadSS3(this, contextt);
        holder = getHolder();
    ...
    public GameThreadSS3 getGameThread() {
        return thread;
    }
